...
if spot is not None and not calls.empty and not puts.empty:
    ...
    with tab4:
        ...
        st.markdown("Strategy guide content...")

else:
    st.warning("⚠️ Market Data Unavailable. The Yahoo Finance API might be throttled or the market is currently closed. Retrying in 60s...")
